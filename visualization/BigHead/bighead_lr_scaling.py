...
optimizer_map = {'adamw': 'adamw', 'mk4': 'dana-star-mk4', 'dana': 'dana', 'ademamix': 'ademamix', 'd-muon': 'd-muon', 'manau': 'manau', 'adamw-decaying-wd': 'adamw-decaying-wd', 'dana-mk4': 'dana-mk4', 'ademamix-decaying-wd': 'ademamix-decaying-wd', 'dana-star-no-tau': 'dana-star-no-tau', 'dana-star': 'dana-star', 'dana-star-no-tau-kappa-0-8': 'dana-star-no-tau-kappa-0-8', 'dana-star-no-tau-kappa-0-85': 'dana-star-no-tau-kappa-0-85', 'dana-star-no-tau-kappa-0-9': 'dana-star-no-tau-kappa-0-9'}
...
def load_wandb_data_simple(project_name, group_name, entity, optimizer_type, scaling_rule,
    ...
    for run in runs:
        ...
        if optimizer_type in ['dana-star-mk4', 'dana', 'adamw-decaying-wd', 'ademamix-decaying-wd', 'dana-mk4', 'dana-star-no-tau', 'dana-star', 'dana-star-no-tau-kappa-0-8', 'dana-star-no-tau-kappa-0-85', 'dana-star-no-tau-kappa-0-9']:
...
if __name__ == '__main__':
    ...
    optimizer_title_map = {'adamw': 'AdamW', 'mk4': 'Dana-Star-MK4', 'dana': 'Dana-Star', 'ademamix': 'AdemaMix', 'd-muon': 'D-Muon', 'manau': 'Manau', 'adamw-decaying-wd': 'AdamW-Decaying-WD', 'dana-mk4': 'Dana-MK4', 'ademamix-decaying-wd': 'Ademamix-Decaying-WD', 'dana-star-no-tau': 'Dana-Star-No-Tau', 'dana-star': 'Dana-Star', 'dana-star-no-tau-kappa-0-8': 'Dana-Star-No-Tau-κ0.8', 'dana-star-no-tau-kappa-0-85': 'Dana-Star-No-Tau-κ0.85', 'dana-star-no-tau-kappa-0-9': 'Dana-Star-No-Tau-κ0.9'}
    ...
    if args.output:
        ...
        optimizer_filename_map = {'adamw': 'AdamW', 'mk4': 'DanaStar-MK4', 'dana': 'DanaStar', 'ademamix': 'AdemaMix', 'd-muon': 'D-Muon', 'manau': 'Manau', 'adamw-decaying-wd': 'AdamW-Decaying-WD', 'dana-mk4': 'Dana-MK4', 'ademamix-decaying-wd': 'Ademamix-Decaying-WD', 'dana-star-no-tau': 'Dana-Star-No-Tau', 'dana-star': 'Dana-Star', 'dana-star-no-tau-kappa-0-8': 'Dana-Star-No-Tau-kappa-0-8', 'dana-star-no-tau-kappa-0-85': 'Dana-Star-No-Tau-kappa-0-85', 'dana-star-no-tau-kappa-0-9': 'Dana-Star-No-Tau-kappa-0-9'}
