...
#export RESULTS_BASE_FOLDER="$HOME/links/projects/def-cypaquet/checkpoints"
...
export RESTART_WRAPPER_SCRIPT="scripts/fir/fir_Qwen3_dana-star-mk4-tau.sh"

# Call the generic Qwen3 restart script with all arguments and force ScaledGPT init scheme
bash scripts/BigHead/Qwen3_generic_restart_tau.sh --init-scheme ScaledGPT --results_base_folder "$RESULTS_BASE_FOLDER" "$@"
