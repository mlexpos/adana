...
export WANDB_RUN_GROUP=Qwen3_testing
...
# Example: Run Qwen3 with 4 heads using dana-star-mk4 optimizer
# Customize the arguments below as needed
bash ./scripts/BigHead/Qwen3.sh --heads 4 --lr 15e-4 --omega 4.0 --optimizer dana-star-mk4
