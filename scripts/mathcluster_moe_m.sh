...
cd /home/math/courtney.paquette@MCGILL.CA/danastar/jax

# Configuration - modify these values as needed
M_VALUES="10000, 1000"  # Comma-separated list of m values (number of experts)
ZETA_VALUE="1.2"  # Single zeta value

cd /home/math/courtney.paquette@MCGILL.CA/danastar/jax

python moe_m_sweeps.py \
    --m_range "$M_VALUES" \
    --zeta "$ZETA_VALUE" \
    --alpha 1.3 \
    --beta 0.0 \
    ...
    --enable_dana_star \
    --random_seed 42 \
    --results_dir /home/math/courtney.paquette@MCGILL.CA/danastarresults
