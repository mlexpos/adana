...
# Enoki AdamW ScaledGPT Initialization Multi-GPU Sweep for Tamia
...
echo "Starting Enoki AdamW ScaledGPT Initialization sweep (Tamia)"
    ...
    for HEADS in "${HEADS_ARRAY[@]}"; do
        ...
        for MULT in "${LR_MULTIPLIERS[@]}"; do
            ...
            sbatch --time=${TIME_HOURS}:00:00 \
                   ...
                   --mem=${MEM} \
                   --job-name=EN_AW_SGPT_om${OMEGA}_h${HEADS}_lr${MULT} \
