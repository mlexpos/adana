...
# Define lr values
lr_values=(2e-5 4e-5 6e-5 8e-5 1e-4)

# Define r values for wd_ts calculation
r_values=( 2 )

# Define clipsnr values
clipsnr_values=(2.0 4.0 8.0)
...
for lr in "${lr_values[@]}"; do
    ...
    for r in "${r_values[@]}"; do
        ...
        for clipsnr in "${clipsnr_values[@]}"; do
            ...
            # Run the tamia dana-star-mk4 script with current parameters
            sbatch ./scripts/diloco330m/tamia-cypaq-dana-star-mk4-sweep.sh --lr $lr --wd_ts $wd_ts --clipsnr $clipsnr
