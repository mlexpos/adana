...
lr_values=(16e-5 24e-5 8e-5 32e-5 12e-5 20e-5)
...
for lr in "${lr_values[@]}"; do
    ...
    for r in "${r_values[@]}"; do
        ...
        # Using 129312 iterations for 330M model
        iterations=129312
        ...
        sbatch ./scripts/diloco330m/tamia-cypaq-adamw-nozloss-sweep.sh --lr $lr --weight_decay $weight_decay
