...
#     scripts/restart_qwen3.sh --opt dana-star-mk4 --heads 6 [launch.sh args...]
#
# Environment:
...
echo "============================================================"
echo "Qwen3 Restart Wrapper (restart #$RESTART_COUNT)"
...
bash "$SCRIPT_DIR/launch.sh" --arch qwen3 --auto_resume "$@"
TRAINING_EXIT_CODE=$?
