...
# Usage: ./tamia-cypaq-dana-star-mk4-sweep.sh --lr <learning_rate> --wd_ts <weight_decay_timestep> --clipsnr <clip_snr>
...
torchrun --standalone --nproc_per_node=4 ./src/main.py --config_format base --model diloco \
    ...
    --z_loss_coeff 0.0 \
    --opt dana-star-mk4 --lr $LR --delta 8 --kappa 0.5 --clipsnr $CLIPSNR \
