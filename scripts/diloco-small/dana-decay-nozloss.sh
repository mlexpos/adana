...
torchrun --standalone --nproc_per_node=1 ./src/main.py --config_format base --model diloco \
    ...
    --z_loss_coeff 0.0 \
    --opt dana --lr 3e-3 --delta 8 --kappa 0.75 --weight_decay 0.04777945005852982 \
    --beta1 0.9 --use_v_ema --v_ema_beta 0.999 --gamma_3_factor 0.5\
...
#     --beta1 0.9 --use_v_ema --v_ema_beta 0.999 \
#     --scheduler cos_inf --cos_inf_steps 0 --div_factor 1e2 --final_div_factor 1e-1 \
#     --wandb --wandb_project $WANDB_PROJECT  --wandb_entity $WANDB_ENTITY \
#     --eval_interval 115