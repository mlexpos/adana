...
export WANDB_RUN_GROUP=DanaStar_MK4_35M_Sweep_WSD
...
# with wsd scheduler that decays to 0 after 75% of steps
# Usage: ./narval-dana-star-mk4-sweep-wsd.sh --lr <learning_rate> --wd_ts <weight_decay_timestep> --clipsnr <clip_snr>
