...
export WANDB_RUN_GROUP=DanaStar_MK4_180M_Sweep_formula12
...
# Usage: ./rorqual-dana-star-mk4-sweep.sh --lr <learning_rate> --wd_ts <weight_decay_timestep> --clipsnr <clip_snr>
