...
# Enoki Dana-Star-No-Tau-Kappa-0-85 ScaledGPT Initialization Single-GPU Sweep for Narval
...
echo "Starting Enoki Dana-Star-No-Tau-Kappa-0-85 ScaledGPT Initialization sweep (Narval)"
    ...
    for HEADS in "${HEADS_ARRAY[@]}"; do
        ...
        for MULT in "${LR_MULTIPLIERS[@]}"; do
            ...
            sbatch --time=${TIME_HOURS}:00:00 \
                   ...
                   --mem=${MEM} \
                   --job-name=EN_Dana-Star-No-Tau-Kappa-0-85_SGPT_om${OMEGA}_h${HEADS}_lr${MULT} \
                   ...
                   --acc_steps $ACC_STEPS \
                   --optimizer dana-star-no-tau-kappa-0-85 \
