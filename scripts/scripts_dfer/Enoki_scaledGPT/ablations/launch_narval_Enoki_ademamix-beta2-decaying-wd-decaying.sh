...
# Enoki Ademamix-beta2-Decaying-WD-decaying ScaledGPT Initialization Single-GPU Sweep for Narval
...
echo "Starting Enoki Ademamix-beta2-Decaying-WD-decaying ScaledGPT Initialization sweep (Narval)"
    ...
    for HEADS in "${HEADS_ARRAY[@]}"; do
        ...
        for MULT in "${LR_MULTIPLIERS[@]}"; do
            ...
            sbatch --time=${TIME_HOURS}:00:00 \
                   ...
                   --mem=${MEM} \
                   --job-name=EN_AdemaMix-beta2-decaying-wd-decaying_SGPT_om${OMEGA}_h${HEADS}_lr${MULT} \
                   ...
                   --acc_steps $ACC_STEPS \
                   --optimizer ademamix-beta2-decaying-wd-decaying \
