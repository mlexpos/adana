...
# Qwen3 Dana-star-mk4 ScaledGPT Initialization Sweep for Narval
...
OMEGA_ARRAY=( 4.0 )
HEADS_ARRAY=( 4 5 )
LR_MULTIPLIERS=( 1.0 1.25 1.5 0.75 0.625 0.5 0.375)
CLIPSNR=2.0
BATCH_SIZE=32
ACC_STEPS=1
...
echo "Starting Qwen3 Dana-star-mk4 ScaledGPT Initialization sweep (Narval)"
