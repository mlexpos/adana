...
# Qwen3Next Dana-MK4 ScaledGPT Initialization Sweep for Narval (4 A100 GPUs)
...
echo "Starting Qwen3Next Dana-MK4 Expert Parallel sweep (Narval)"
    ...
    for HEADS in "${HEADS_ARRAY[@]}"; do
        ...
        for MULT in "${LR_MULTIPLIERS[@]}"; do
            ...
            sbatch --time=${TIME_HOURS}:00:00 \
                   ...
                   --mem=${MEM} \
                   --job-name=Q3N_MK4_SGPT_om${OMEGA}_h${HEADS}_lr${MULT} \
