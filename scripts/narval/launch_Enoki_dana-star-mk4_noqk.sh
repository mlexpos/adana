...
# Enoki DanaStar-MK4 ScaledGPT Initialization Sweep for Narval (no QK norm)
...
echo "Starting Enoki DanaStar-MK4 ScaledGPT Initialization sweep (Narval, no QK norm)"
