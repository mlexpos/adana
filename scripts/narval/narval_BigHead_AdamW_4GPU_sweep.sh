...
# BigHead AdamW Multi-GPU Sweep for depths {9,10}
...
for DEPTH in "${DEPTHS[@]}"; do
    ...
    # Calculate base learning rate using NEW formula: lr = 8.0e+01 * P^(-0.64)
    BASE_LR=$(python3 -c "print(8.0e+01 * ($NON_EMB ** -0.64))")
