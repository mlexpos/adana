...
lr_values=( 1e-4 2e-4 4e-4 6e-4 8e-4 1e-3 2e-3 4e-4 6e-3 8e-3 1e-2)
...
for lr in "${lr_values[@]}"; do
    ...
    for r in "${r_values[@]}"; do
        ...
        # Run the adam-star script with current parameters
        sbatch ./scripts/diloco180m/narval-cypaq-adam-star-nozloss-sweep.sh --lr $lr --wd_ts $wd_ts
