...
# Enoki DanaStar-MK4 ScaledGPT Initialization Single-GPU Sweep for Narval
...
LR_MULTIPLIERS=( 1.0 1.25 0.75 1.5 0.50 1.75 0.25 )
CLIPSNR=2.0
...
echo "Starting Enoki DanaStar-MK4 ScaledGPT Initialization sweep (Narval)"
