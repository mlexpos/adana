...
class GPTBase(nn.Module):
    ...
    def get_num_params(self, non_embedding=True, exclude_embeddings=False):
        ...
        If exclude_embeddings=True, excludes both token embeddings and LM head,
        showing only transformer block parameters.
        """
    ...
    def get_parameter_group_specs(self):
        ...
        # Only remove lm_head.weight when weight tying is enabled
        if self.config.weight_tying and "lm_head.weight" in decay:
